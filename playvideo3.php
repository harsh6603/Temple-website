            ...
            <div class="row">
                <div class="play-video">
                    <div class="responsive">
                        <iframe src="online rangoli competition __ Anand pathshala(19) and Vvnagar pathshala(13) birthday celebration ( 720 X 1280 ).mp4" title="YouTube video player" 
                        frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                        allowfullscreen></iframe>
                    </div>
                    <h3><?php echo $name?></h3>
                    <p><?php echo $viewStart ?> views  &bull; <?php echo old($time) ?></p>
